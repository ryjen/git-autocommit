...
text = path.read_text()
old = '''fn staged_context(repo: &Repo, files: &[String], max_bytes: usize) -> Result<String> {
...
'''
new = '''fn is_low_value_diff(path: &str) -> bool {
...
'''
if old not in text:
    raise SystemExit("staged_context block not found")
